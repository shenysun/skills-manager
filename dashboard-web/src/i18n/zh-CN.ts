export default {
  ...
  init: {
    ...
    title: '导入运行时技能',
    scanning: '正在扫描运行时目录…',
    hint: '选中的技能将移入技能库;原目录先备份,原位置变为指回技能库的链接。',
    empty: '没有在 agent 运行时目录发现可导入的技能。',
    managedBadge: '已管理',
    conflictBadge: '冲突',
    choicePlaceholder: '跳过(选择版本后导入)',
    keepHub: '保留库中版本',
    preferHint: '可选:按此顺序裁决冲突;未列入的跳过,逐行选择优先。',
    preferAdd: '搜索并加入优先级…',
    preferNoMatch: '无匹配',
    preferRemove: '移除',
    preferUp: '上移',
  ...
  add: {
    ...
    title: '＋添加技能',
    cancel: '取消',
    sourcePlaceholder: '来源:本地路径 / .zip / Git URL / GitHub(owner/repo)/ http(s) 技能链接 / marketplace 仓库',
    discover: '发现',
    discovering: '发现中…',
    ...
    formatAsk: '无法自动识别该 URL 的内容——它是什么格式?',
    formatMd: '单文件 SKILL.md',
    formatZip: 'zip 归档',
    formatTar: 'tar / tar.gz 归档',
    insecureAsk: '该链接使用不加密的 http,下载内容可能在传输中被篡改。确认继续吗?',
    insecureConfirm: '确认使用 http 下载',
    pluginSkills: '{n} 个技能',
    pluginUnsupported: '暂不支持:{reason}',
    reasonGitSubdir: '插件源指向另一个 git 仓库',
    reasonUrl: '插件源是一个外部 URL',
    reasonExternal: '插件源形态不受支持',
  },
  log: {
    link: '日志',
    title: '日志',
