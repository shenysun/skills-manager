export default {
  ...
  init: {
    ...
    hint: 'Selected skills move into the library; each origin is backed up first and its old spot becomes a link back to the hub.',
    ...
    preferHint: 'Optional: clashes resolve in this order; unlisted ones stay skipped, per-row picks win.',
    preferAdd: 'Search to add…',
    preferNoMatch: 'No match',
    preferRemove: 'Remove',
    preferUp: 'Up',
    preferDown: 'Down',
    preferHub: 'hub',
  ...
  add: {
    ...
    title: '＋ Add skills',
    cancel: 'Cancel',
    sourcePlaceholder: 'Source: local path / .zip / Git URL / GitHub (owner/repo) / http(s) skill link / marketplace repo',
    discover: 'Discover',
    ...
    formatAsk: 'Could not auto-identify the URL payload — what format is it?',
    formatMd: 'Single SKILL.md file',
    formatZip: 'zip archive',
    formatTar: 'tar / tar.gz archive',
    insecureAsk: 'This link uses unencrypted http — the download could be tampered with in transit. Continue?',
    insecureConfirm: 'Download over http anyway',
    pluginSkills: '{n} skills',
    pluginUnsupported: 'Not supported yet: {reason}',
    reasonGitSubdir: 'the plugin lives in another git repository',
    reasonUrl: 'the plugin lives at an external URL',
    reasonExternal: 'unsupported plugin source shape',
  },
  log: {
    link: 'Log',
    title: 'Operation log',
