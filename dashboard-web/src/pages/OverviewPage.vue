    ...
    <n-grid :cols="2" :x-gap="18" :y-gap="18" responsive="screen">
        ...
        <n-card>
          ...
          <n-space vertical size="large">
            <section>
              ...
              <EmptyState v-if="!state?.doctor?.warnings?.length" title="No warnings" />
            ...
            <section>
              ...
              <EmptyState v-if="!state?.doctor?.brokenLinks?.length" title="No broken symlinks" />
              <n-list v-else bordered>
      ...
      <n-gi>
        <n-card :title="t('overview.git')">
          <n-space vertical size="large">
            <n-log :log="state?.doctor?.gitStatus || 'clean'" trim />
            <section>
